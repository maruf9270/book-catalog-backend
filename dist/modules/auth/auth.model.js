...
authSchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const hashedPasswrod = yield bcrypt_1.default.hash(givenPassword, Number(config_1.default.salt_rounds));
        user.password = hashedPasswrod;
        user.email = upperCasedEmail;
        next();
    });
});
const User = (0, mongoose_1.model)("User", authSchema);
exports.AuthModel = { User };
